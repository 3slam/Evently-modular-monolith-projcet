...
public static class PresentationServiceRegister
{
    public static void RegisterAllClassesThatImplementIEndpoint(this IServiceCollection services, Assembly assembly)
    {
